...
public class PieChartActivityAge extends Activity implements OnChartValueSelectedListener {
    private static final String TAG = PieChartActivityAge.class.getSimpleName();
...
//        mChart.setHoleColor(Color.WHITE);
                                ...
                                .subscribe(new Subscriber<ResponseBean>() {
                                    ...
                                    public void onNext(ResponseBean responseBean) {
                                        ...
                                        if (pieChartBean != null) {
                                            List<PieChartBean.AgeBean> age = pieChartBean.getAge();
                                            dealWithData(age);
                                        }
                                    }
                                });
    ...
    private void dealWithData(List<PieChartBean.AgeBean> age) {
        if (age != null && age.size() > 0) {
            ArrayList<PieEntry> entries = new ArrayList<PieEntry>();
            for (PieChartBean.AgeBean bean : age) {
