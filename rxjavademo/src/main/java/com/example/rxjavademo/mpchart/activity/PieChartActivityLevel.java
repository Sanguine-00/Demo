...
public class PieChartActivityLevel extends Activity implements OnChartValueSelectedListener {
    private static final String TAG = PieChartActivityLevel.class.getSimpleName();
...
//        mChart.setHoleColor(Color.WHITE);
                                ...
                                .subscribe(new Subscriber<ResponseBean>() {
                                    ...
                                    public void onNext(ResponseBean responseBean) {
                                        ...
                                        if (pieChartBean != null) {
                                            List<PieChartBean.LevelBean> level = pieChartBean.getLevel();
                                            dealWithData(level);
                                        }
                                    }
                                });
    ...
    private void dealWithData(List<PieChartBean.LevelBean> level) {
        if (level != null && level.size() > 0) {
            ArrayList<PieEntry> entries = new ArrayList<PieEntry>();
            for (PieChartBean.LevelBean bean : level) {
