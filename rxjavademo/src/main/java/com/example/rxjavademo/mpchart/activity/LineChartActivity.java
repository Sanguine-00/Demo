...
import com.example.rxjavademo.mpchart.bean.MemberTrendBean;
...
public class LineChartActivity extends FragmentActivity implements OnChartValueSelectedListener {

    ArrayList<Entry> yVals = new ArrayList<Entry>();
    private LineChart mChart;
    private String TAG = LineChartActivity.class.getSimpleName();
    ...
    private void getData() {
        AuthHelper.auth(MemberTrend.class).subscribeOn(Schedulers.io())
                .subscribe(new Action1<MemberTrend>() {
                    @Override
                    public void call(final MemberTrend memberTrend) {
                        Map<String, Object> map = new HashMap<>();
                        map.put("beginDate", "2018-03-01");
                        map.put("endDate", "2018-03-26");
                        Observable<ResponseBean> observable = memberTrend.getTrend(map);
                                ...
                                .subscribe(new Subscriber<ResponseBean>() {
                                    ...
                                    public void onNext(ResponseBean responseBean) {
                                        if (responseBean == null) {
                                            Toast.makeText(LineChartActivity.this, "服务异常", Toast.LENGTH_SHORT).show();
                                            return;
                                        }
