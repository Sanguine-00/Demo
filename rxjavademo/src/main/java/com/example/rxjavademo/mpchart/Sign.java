...
//        requestMap.put("appVersion", CommonUtil.getVersion(ContextHandler.getContext()));
//        /*3. uid 会员Id，做访问统计用*/
//        String memberUid = LoginHelper.getInstance().getMemberId();
//        if (!TextUtils.isEmpty(memberUid)) {
//            requestMap.put("appUid", memberUid);
//        }
//        /*4. osVersion 操作系统版本号，做访问统计用*/
//        requestMap.put("osVersion", CommonUtil.getOsVersion(ContextHandler.getContext()));
//        /*5. model 机型，做访问统计用*/
//        String model = CommonUtil.getBuildModel();
...
//        requestMap.put("clientAppName", Config.CLIENT_APP_NAME);
        ...
        requestMap.put("rnd", UUID.randomUUID().toString().replace("-", ""));
//        /*8. 添加accessToken*/
...
//        /*10. 固定的APPKEY*/
//        requestMap.put("appKey", Config.APP_KEY_USER_ANDROID);
//        /*11. 加上mallId参数*/
//        String mallId = LibraryMallHelper.getMallId(ContextHandler.getContext());
...
//        long modOftm = tm % 10;
//        // 根据模值，获得不同的key
//        String key = Config.APP_SECRET_KEY_USER_ANDROID[(int) modOftm];
